...
### 材质更新流程
1. **配置更新**: `MaterialSystem:147-156` - 更新材质配置状态
2. **应用更新**: `MaterialSystem:166-206` - 遍历场景对象更新材质属性
3. **标记更新**: `MaterialSystem:203` - 设置material.needsUpdate触发GPU同步
...
### 预设系统流程
1. **预设定义**: `MaterialSystem:258-310` - 内置材质预设（金属、塑料、木材、玻璃、织物）
2. **变体创建**: `MaterialSystem:329-358` - 基于配置生成材质变体
3. **预设应用**: 通过createPresetMaterial()快速应用预设配置
...
这个PBR材质系统通过基于物理的渲染模型、高效的缓存策略和灵活的预设系统，为产品可视化提供了专业级的材质渲染能力。