...
export class DebugSystem {
    ...
    private createLightHelpersFolder(): void {
        ...
        folder.add(this.uiControls, 'showLightHelpers')
            .name('显示Helper')
    ...
    private createBufferVisualizationFolder(): void {
        ...
        folder.add(this.uiControls, 'bufferMode', modeOptions)
            .name('显示模式')
        ...
        // 添加快速切换按钮
        folder.add({ cycle: () => this.cycleBufferMode() }, 'cycle')
            .name('切换下一模式');

        folder.add({ reset: () => this.resetBufferMode() }, 'reset')
            .name('重置为默认');
    ...
    private createPostProcessFolder(): void {
        ...
        folder.add(this.uiControls, 'ssaoEnabled')
            .name('SSAO')
            .onChange((value: boolean) => {
                this.postProcessSystem.toggleSSAO(value);
            });

        folder.add(this.uiControls, 'bloomEnabled')
            .name('Bloom')
            .onChange((value: boolean) => {
