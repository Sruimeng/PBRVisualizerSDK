import type { AnimationStateMachine, StateMachineEvent } from '@sruim/pbr-visualizer-sdk';
  ...
  private createStateMachine(): void {
    ...
    if (this.stateMachine) {
      ...
      this.stateMachine.on('transitionStart', (event: StateMachineEvent) => {
        console.log(
          `[StateMachineDemo] Transition started: ${event.previousState} -> ${event.currentState}`,
        );
